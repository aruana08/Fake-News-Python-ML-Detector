# Fake-News-Python-ML-Detector
Fake news detection model using Kaggle datasets, applying TF-IDF vectorization, regex-based text cleaning, and multiple classifiers (Logistic Regression, Decision Tree, Random Forest) to distinguish between real and fake news
